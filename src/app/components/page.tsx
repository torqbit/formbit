          ...
          <ol className='mt-8 space-y-6'>
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink href='https://github.com/torqbit/ts-nextjs-tailwind-starter/blob/main/src/styles/colors.css'>
            ...
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnstyledLink href='https://torqbit.com'>
                  Outside Links
                </UnstyledLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <PrimaryLink href='https://torqbit.com'>
                  Outside Links
                </PrimaryLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnderlineLink href='https://torqbit.com'>
                  Outside Links
                </UnderlineLink>
              </div>
            </li>
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <ButtonLink variant='primary' href='https://torqbit.com'>
                  Primary Variant
                </ButtonLink>
                <ButtonLink
                  variant='outline'
                  isDarkBg={mode === 'dark'}
                  href='https://torqbit.com'
                >
                  Outline Variant
                </ButtonLink>
                <ButtonLink
                ...
                <ButtonLink variant='dark' href='https://torqbit.com'>
                  Dark Variant
                </ButtonLink>
                <ButtonLink variant='light' href='https://torqbit.com'>
                  Light Variant
                </ButtonLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <Button variant='light'>Icon</Button>
              </div>
